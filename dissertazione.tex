...
\section{A categorical approach to GNNs}
...
\cite{dudzik2022graph} propose the integral transform encoded by the polynomial span in ADDIM as the supporting structure of the algorithm. The functions $i$, $p$, and $o$ are defined as follows:
\begin{enumerate}
